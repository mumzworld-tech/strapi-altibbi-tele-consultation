...
export interface ApiConfigurationConfiguration extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    height: Schema.Attribute.Component<'content.slider', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    weight: Schema.Attribute.Component<'content.slider', false>;
  };
}
...
export interface ApiDashboardDashboard extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    >;
    ourProcess: Schema.Attribute.Component<'content.our-process', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    consultationId: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    currencyCode: Schema.Attribute.Enumeration<['SAR', 'AED']>;
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    locales: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::order.order'> &
      Schema.Attribute.Private;
    mainConcern: Schema.Attribute.Text;
...
export interface ApiPackagePackage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    features: Schema.Attribute.Component<'content.checked-list', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
